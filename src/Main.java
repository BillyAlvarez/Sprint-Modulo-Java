        ...
        while (opcion != 9) {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    String nombreCliente = validarDato(scanner.nextLine(), 10, 50);
                    System.out.print("Ingrese el apellido del cliente: ");
                    String apellidoCliente = validarDato(scanner.nextLine(), 10, 50);
                ...
                case 2:
                    ...
                    String nombreProfesional = validarDato(scanner.nextLine(), 10, 50);
